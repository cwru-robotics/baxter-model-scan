...
#ifndef CALIBRATION_PCL_UTILS_H_
#define CALIBRATION_PCL_UTILS_H_
...
class CalibrationPclUtils
{
public:
    CalibrationPclUtils(ros::NodeHandle* nodehandle); //constructor
...
// 
    ...
    void find_block(Eigen::Vector3f& centroid, Eigen::Vector3f& orientation, Eigen::Vector3d& color);
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr getKinectColorCloud();
private:
    ros::NodeHandle nh_; 
